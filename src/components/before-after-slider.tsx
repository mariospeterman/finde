    ...
    <div className={`paper-sheet space-y-6 p-6 sm:p-8 ${className}`}>
      <div className="flex items-center justify-between text-xs uppercase tracking-[0.35em] text-slate-500">
        ...
        <span className="inline-flex items-center gap-2 text-slate-500">
          <ShieldCheck className="h-4 w-4 text-emerald-400" aria-hidden="true" focusable="false" />
          Flow with Finde
        </span>
      </div>
      <div className="relative aspect-[16/10] overflow-hidden rounded-3xl border border-white/40 bg-slate-900/5">
        ...
        <div
          className="pointer-events-none absolute inset-y-0 w-[2px] bg-slate-900/20 backdrop-blur-sm"
          style={{ left: handlePosition, transform: "translateX(-50%)" }}
        />
        <div
          className="absolute top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 shadow-md"
        ...
        <input
          ...
          className="absolute bottom-4 left-1/2 w-[60%] -translate-x-1/2 cursor-pointer accent-emerald-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-sky-300 focus-visible:outline-offset-2"
